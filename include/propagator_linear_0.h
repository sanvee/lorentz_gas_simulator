...
public:
    ...
    //**Squares**//
    //***********//
    LinearPropagator_0 ( SimulationBox::PeriodicBoxSquareObstacles &simbox, Trajectory::Linear &trajectory, Neighbourlist::Linear &neighlist )
    {
        ...
        {
            std::cout << std::endl << "---Propagator(linear_0)---" << std::endl;
...
public:
    ...
    template<class T_Obstacles> //ex propagate_0
    inline void propagate ( double end_time, T_Obstacles *obstacles )
    {
        ...
        while ( trajectory_->current_time_ <= end_time )
        {
            ...
            {
                last_collided_item_ = mirror_0 ( *obstacles, collided_obstacles_[iklo1], klo1 );
                reenter = 0;
                k_reenter = 0.0;
                break;
            }
            ...
            {
                last_collided_item_ = mirror_0 ( *obstacles, collided_obstacles_[iklo2], klo2 );
                reenter = 0;
                k_reenter = 0.0;
                break;
            }
