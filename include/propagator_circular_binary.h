...
class CircularPropagatorBinary
{
...
public:
    ...
    CircularPropagatorBinary ( Simbox &simbox, Trajectory::Circular &trajectory, Neighbourlist::Circular &neighlist, bool filter )
    {
        ...
        /// x and y value stored consecutively
...
public:
    ...
    void propagate ( double end_time, Obstacles::Binary<T_obs1, T_obs2> &obstacles )
    {
    ...
    template<class T_obs1, class T_obs2>
    inline int getIntersections ( Obstacles::Binary<T_obs1, T_obs2> &obstacles )
    {
        double x_tr = trajectory_->rx_;
        double y_tr = trajectory_->ry_;
        double r_tr = trajectory_->radius_;
